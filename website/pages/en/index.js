        ...
        <div className="mainContainer">
          <Container padding={['bottom', 'top']} background="dark">
            <h2>Welcome to VirtualBox Tutorial!</h2>
              ...
              <br /><br />
              In just 10 SHORT chapters, you will install <a href="https://mxlinux.org/">MX Linux</a> on virtual machine with <a href="https://www.virtualbox.org/">VirtualBox</a>.  In the unlikely event that you don't like MX Linux, you can use VirtualBox to try out other Linux distros.  In fact, VirtualBox is very popular with distro hoppers, because it makes it possible to try out a Linux distro without disrupting the host OS.
          </Container>
        </div>
      </div>
    );
